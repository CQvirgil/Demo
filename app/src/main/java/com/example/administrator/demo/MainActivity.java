...
import com.example.administrator.demo.Music.LinkMusicService;
import com.example.administrator.demo.Music.MyMusicService;
...
// 获取所有歌曲
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                musicInfo = new MusicInfo(title,url,duration,singer,album,size);
                list.add(musicInfo);
